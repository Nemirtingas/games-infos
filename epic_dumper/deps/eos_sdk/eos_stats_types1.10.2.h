...
#define EOS_STATS_INGESTSTAT_API_003 3

/**
 * Input parameters for the EOS_Stats_IngestStat function.
 */
EOS_STRUCT(EOS_Stats_IngestStatOptions003, (
...
#define EOS_STATS_QUERYSTATS_API_003 3

/**
 * Input parameters for the EOS_Stats_QueryStats function.
 */
EOS_STRUCT(EOS_Stats_QueryStatsOptions003, (
	/** API Version. */
	int32_t ApiVersion;
