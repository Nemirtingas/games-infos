...
#define EOS_CUSTOMINVITES_SETCUSTOMINVITE_API_001 1

EOS_STRUCT(EOS_CustomInvites_SetCustomInviteOptions001, (
...
#define EOS_CUSTOMINVITES_SENDCUSTOMINVITE_API_001 1

/**
 * Input parameters for the EOS_CustomInvites_SendCustomInvite function.
 */
EOS_STRUCT(EOS_CustomInvites_SendCustomInviteOptions001, (
...
EOS_STRUCT(EOS_CustomInvites_SendCustomInviteCallbackInfo, (
	enum { k_iCallback = k_iCustomInvitesCallbacks + 0 };
...
#define EOS_CUSTOMINVITES_ADDNOTIFYCUSTOMINVITERECEIVED_API_001 1

EOS_STRUCT(EOS_CustomInvites_AddNotifyCustomInviteReceivedOptions001, (
...
EOS_STRUCT(EOS_CustomInvites_OnCustomInviteReceivedCallbackInfo, (
	enum { k_iCallback = k_iCustomInvitesCallbacks + 1 };
...
#define EOS_CUSTOMINVITES_ADDNOTIFYCUSTOMINVITEACCEPTED_API_001 1

EOS_STRUCT(EOS_CustomInvites_AddNotifyCustomInviteAcceptedOptions001, (
...
EOS_STRUCT(EOS_CustomInvites_OnCustomInviteAcceptedCallbackInfo, (
	enum { k_iCallback = k_iCustomInvitesCallbacks + 2 };
...
#define EOS_CUSTOMINVITES_FINALIZEINVITE_API_001 1

EOS_STRUCT(EOS_CustomInvites_FinalizeInviteOptions001, (
