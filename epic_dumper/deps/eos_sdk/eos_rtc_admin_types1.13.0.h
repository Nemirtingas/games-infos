...
#define EOS_RTCADMIN_QUERYJOINROOMTOKEN_API_002 2

/**
 * Input parameters for the EOS_RTCAdmin_QueryJoinRoomToken function.
 */
EOS_STRUCT(EOS_RTCAdmin_QueryJoinRoomTokenOptions002, (
...
EOS_STRUCT(EOS_RTCAdmin_QueryJoinRoomTokenCompleteCallbackInfo, (
	enum { k_iCallback = k_iRTCAdminCallbackBase + 0 };
...
#define EOS_RTCADMIN_USERTOKEN_API_001 1

/**
 * Contains information about a collection of user tokens for joining a room.
 */
EOS_STRUCT(EOS_RTCAdmin_UserToken001, (
...
#define EOS_RTCADMIN_COPYUSERTOKENBYINDEX_API_002 2

/**
 * Input parameters for the EOS_RTCAdmin_CopyUserTokenByIndex function.
 */
EOS_STRUCT(EOS_RTCAdmin_CopyUserTokenByIndexOptions002, (
...
#define EOS_RTCADMIN_COPYUSERTOKENBYUSERID_API_002 2

/**
 * Input parameters for the EOS_RTCAdmin_CopyUserTokenByUserId function.
 */
EOS_STRUCT(EOS_RTCAdmin_CopyUserTokenByUserIdOptions002, (
...
#define EOS_RTCADMIN_KICK_API_001 1

/**
 * Input parameters for the EOS_RTCAdmin_Kick function.
 */
EOS_STRUCT(EOS_RTCAdmin_KickOptions001, (
...
EOS_STRUCT(EOS_RTCAdmin_KickCompleteCallbackInfo, (
	enum { k_iCallback = k_iRTCAdminCallbackBase + 1 };
	/** The EOS_EResult code for the operation. EOS_Success indicates that the operation succeeded; other codes indicate errors. */
	EOS_EResult ResultCode;
...
#define EOS_RTCADMIN_SETPARTICIPANTHARDMUTE_API_001 1

/**
 * Input parameters for the EOS_RTCAdmin_SetParticipantHardMute function.
 */
EOS_STRUCT(EOS_RTCAdmin_SetParticipantHardMuteOptions001, (
...
EOS_STRUCT(EOS_RTCAdmin_SetParticipantHardMuteCompleteCallbackInfo, (
	enum { k_iCallback = k_iRTCAdminCallbackBase + 2 };
	/** The EOS_EResult code for the operation. EOS_Success indicates that the operation succeeded; other codes indicate errors. */
	EOS_EResult ResultCode;
