...
EOS_STRUCT(EOS_AntiCheatClient_OnMessageToServerCallbackInfo, (
	enum { k_iCallback = k_iAntiCheatClientCallbackBase + 0 };
...
#define EOS_ANTICHEATCLIENT_ADDNOTIFYMESSAGETOSERVER_API_001 1
EOS_STRUCT(EOS_AntiCheatClient_AddNotifyMessageToServerOptions001, (
	/** API Version: Set this to EOS_ANTICHEATCLIENT_ADDNOTIFYMESSAGETOSERVER_API_LATEST. */
	int32_t ApiVersion;
));

#define EOS_ANTICHEATCLIENT_ADDNOTIFYMESSAGETOPEER_API_001 1
EOS_STRUCT(EOS_AntiCheatClient_AddNotifyMessageToPeerOptions001, (
	/** API Version: Set this to EOS_ANTICHEATCLIENT_ADDNOTIFYMESSAGETOPEER_API_LATEST. */
	int32_t ApiVersion;
));

#define EOS_ANTICHEATCLIENT_ADDNOTIFYPEERACTIONREQUIRED_API_001 1
EOS_STRUCT(EOS_AntiCheatClient_AddNotifyPeerActionRequiredOptions001, (
	/** API Version: Set this to EOS_ANTICHEATCLIENT_ADDNOTIFYPEERACTIONREQUIRED_API_LATEST. */
	int32_t ApiVersion;
));

#define EOS_ANTICHEATCLIENT_ADDNOTIFYPEERAUTHSTATUSCHANGED_API_001 1
EOS_STRUCT(EOS_AntiCheatClient_AddNotifyPeerAuthStatusChangedOptions001, (
	/** API Version: Set this to EOS_ANTICHEATCLIENT_ADDNOTIFYPEERAUTHSTATUSCHANGED_API_LATEST. */
	int32_t ApiVersion;
));

#define EOS_ANTICHEATCLIENT_BEGINSESSION_API_003 3
EOS_STRUCT(EOS_AntiCheatClient_BeginSessionOptions003, (
...
#define EOS_ANTICHEATCLIENT_ENDSESSION_API_001 1
EOS_STRUCT(EOS_AntiCheatClient_EndSessionOptions001, (
	/** API Version: Set this to EOS_ANTICHEATCLIENT_ENDSESSION_API_LATEST. */
	int32_t ApiVersion;
));

#define EOS_ANTICHEATCLIENT_POLLSTATUS_API_001 1
EOS_STRUCT(EOS_AntiCheatClient_PollStatusOptions001, (
...
#define EOS_ANTICHEATCLIENT_ADDEXTERNALINTEGRITYCATALOG_API_001 1
EOS_STRUCT(EOS_AntiCheatClient_AddExternalIntegrityCatalogOptions001, (
...
#define EOS_ANTICHEATCLIENT_RECEIVEMESSAGEFROMSERVER_API_001 1
EOS_STRUCT(EOS_AntiCheatClient_ReceiveMessageFromServerOptions001, (
...
#define EOS_ANTICHEATCLIENT_GETPROTECTMESSAGEOUTPUTLENGTH_API_001 1
EOS_STRUCT(EOS_AntiCheatClient_GetProtectMessageOutputLengthOptions001, (
...
#define EOS_ANTICHEATCLIENT_PROTECTMESSAGE_API_001 1
EOS_STRUCT(EOS_AntiCheatClient_ProtectMessageOptions001, (
...
#define EOS_ANTICHEATCLIENT_UNPROTECTMESSAGE_API_001 1
EOS_STRUCT(EOS_AntiCheatClient_UnprotectMessageOptions001, (
...
#define EOS_ANTICHEATCLIENT_REGISTERPEER_API_001 1
EOS_STRUCT(EOS_AntiCheatClient_RegisterPeerOptions001, (
...
#define EOS_ANTICHEATCLIENT_UNREGISTERPEER_API_001 1
EOS_STRUCT(EOS_AntiCheatClient_UnregisterPeerOptions001, (
...
#define EOS_ANTICHEATCLIENT_RECEIVEMESSAGEFROMPEER_API_001 1
EOS_STRUCT(EOS_AntiCheatClient_ReceiveMessageFromPeerOptions001, (
