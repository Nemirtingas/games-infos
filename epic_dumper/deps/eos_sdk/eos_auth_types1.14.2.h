...
EOS_STRUCT(EOS_Auth_LinkAccountCallbackInfo, (
	 ...
	 *
	 * Once the user has logged in with their Epic Account, the account will be linked with the external account supplied when EOS_Auth_Login was called.
...
#define EOS_AUTH_COPYIDTOKEN_API_001 1

/**
 * Input parameters for the EOS_Auth_CopyIdToken function.
 */
EOS_STRUCT(EOS_Auth_CopyIdTokenOptions001, (
...
#define EOS_AUTH_IDTOKEN_API_001 1
 ...
 */
EOS_STRUCT(EOS_Auth_IdToken001, (
...
#define EOS_AUTH_QUERYIDTOKEN_API_001 1

/**
 * Input parameters for the EOS_Auth_QueryIdToken function.
 */
EOS_STRUCT(EOS_Auth_QueryIdTokenOptions001, (
...
#define EOS_AUTH_VERIFYIDTOKEN_API_001 1

/**
 * Input parameters for the EOS_Auth_VerifyIdToken function.
 */
EOS_STRUCT(EOS_Auth_VerifyIdTokenOptions001, (
...
EOS_STRUCT(EOS_Auth_DeletePersistentAuthCallbackInfo, (
	enum { k_iCallback = k_iAuthCallbackBase + 6 };
...
EOS_STRUCT(EOS_Auth_LoginStatusChangedCallbackInfo, (
	enum { k_iCallback = k_iAuthCallbackBase + 7 };
