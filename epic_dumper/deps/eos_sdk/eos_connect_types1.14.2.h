...
#define EOS_CONNECT_IDTOKEN_API_001 1
 ...
 */
EOS_STRUCT(EOS_Connect_IdToken001, (
...
#define EOS_CONNECT_COPYIDTOKEN_API_001 1

/**
 * Input parameters for the EOS_Connect_CopyIdToken function.
 */
EOS_STRUCT(EOS_Connect_CopyIdTokenOptions001, (
...
#define EOS_CONNECT_VERIFYIDTOKEN_API_001 1

/**
 * Input parameters for the EOS_Connect_VerifyIdToken function.
 */
EOS_STRUCT(EOS_Connect_VerifyIdTokenOptions001, (
...
EOS_STRUCT(EOS_Connect_VerifyIdTokenCallbackInfo, (
	enum { k_iCallback = k_iConnectCallbackBase + 11 };
	/** The EOS_EResult code for the operation. EOS_Success indicates that the operation succeeded; other codes indicate errors. */
	EOS_EResult ResultCode;
