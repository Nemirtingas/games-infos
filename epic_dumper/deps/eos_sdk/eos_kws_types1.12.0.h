...
#define EOS_KWS_PERMISSIONSTATUS_API_001 1

EOS_STRUCT(EOS_KWS_PermissionStatus001, (
...
#define EOS_KWS_QUERYAGEGATE_API_001 1

/**
 * Input parameters for the EOS_KWS_QueryAgeGate function.
 */
EOS_STRUCT(EOS_KWS_QueryAgeGateOptions001, (
...
EOS_STRUCT(EOS_KWS_QueryAgeGateCallbackInfo, (
	enum { k_iCallback = k_iKwsCallbackBase + 0 };
...
#define EOS_KWS_CREATEUSER_API_001 1

/**
 * Input parameters for the EOS_KWS_CreateUser function.
 */
EOS_STRUCT(EOS_KWS_CreateUserOptions001, (
...
EOS_STRUCT(EOS_KWS_CreateUserCallbackInfo, (
	enum { k_iCallback = k_iKwsCallbackBase + 1 };
	/** The EOS_EResult code for the operation. EOS_Success indicates that the operation succeeded; other codes indicate errors. */
	EOS_EResult ResultCode;
...
#define EOS_KWS_QUERYPERMISSIONS_API_001 1

/**
 * Input parameters for the EOS_KWS_QueryPermissions function.
 */
EOS_STRUCT(EOS_KWS_QueryPermissionsOptions001, (
...
EOS_STRUCT(EOS_KWS_QueryPermissionsCallbackInfo, (
	enum { k_iCallback = k_iKwsCallbackBase + 2 };
	/** The EOS_EResult code for the operation. EOS_Success indicates that the operation succeeded; other codes indicate errors. */
	EOS_EResult ResultCode;
...
#define EOS_KWS_UPDATEPARENTEMAIL_API_001 1

/**
 * Input parameters for the EOS_KWS_UpdateParentEmail function.
 */
EOS_STRUCT(EOS_KWS_UpdateParentEmailOptions001, (
...
EOS_STRUCT(EOS_KWS_UpdateParentEmailCallbackInfo, (
	enum { k_iCallback = k_iKwsCallbackBase + 3 };
	/** The EOS_EResult code for the operation. EOS_Success indicates that the operation succeeded; other codes indicate errors. */
	EOS_EResult ResultCode;
...
#define EOS_KWS_REQUESTPERMISSIONS_API_001 1

/**
 * Input parameters for the EOS_KWS_RequestPermissions function.
 */
EOS_STRUCT(EOS_KWS_RequestPermissionsOptions001, (
...
EOS_STRUCT(EOS_KWS_RequestPermissionsCallbackInfo, (
	enum { k_iCallback = k_iKwsCallbackBase + 4 };
	/** The EOS_EResult code for the operation. EOS_Success indicates that the operation succeeded; other codes indicate errors. */
	EOS_EResult ResultCode;
...
#define EOS_KWS_GETPERMISSIONSCOUNT_API_001 1

/**
 * Input parameters for the EOS_KWS_GetPermissionsCount function.
 */
EOS_STRUCT(EOS_KWS_GetPermissionsCountOptions001, (
...
#define EOS_KWS_COPYPERMISSIONBYINDEX_API_001 1

/**
 * Input parameters for the EOS_KWS_CopyPermissionByIndex function.
 */
EOS_STRUCT(EOS_KWS_CopyPermissionByIndexOptions001, (
...
/** The most recent version of the EOS_KWS_CreateUser API. */
#define EOS_KWS_GETPERMISSIONBYKEY_API_001 1

/**
 * Input parameters for the EOS_KWS_GetPermissionByKey function.
 */
EOS_STRUCT(EOS_KWS_GetPermissionByKeyOptions001, (
...
#define EOS_KWS_ADDNOTIFYPERMISSIONSUPDATERECEIVED_API_001 1

EOS_STRUCT(EOS_KWS_AddNotifyPermissionsUpdateReceivedOptions001, (
...
EOS_STRUCT(EOS_KWS_PermissionsUpdateReceivedCallbackInfo, (
	enum { k_iCallback = k_iKwsCallbackBase + 5 };
