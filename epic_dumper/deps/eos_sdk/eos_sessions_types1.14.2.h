...
#define EOS_SESSIONS_CREATESESSIONMODIFICATION_API_004 4

/**
 * Input parameters for the EOS_Sessions_CreateSessionModification function.
 */
EOS_STRUCT(EOS_Sessions_CreateSessionModificationOptions004, (
...
#define EOS_SESSIONS_REGISTERPLAYERS_API_002 2

/**
 * Input parameters for the EOS_Sessions_RegisterPlayers function.
 */
EOS_STRUCT(EOS_Sessions_RegisterPlayersOptions002, (
...
#define EOS_SESSIONS_UNREGISTERPLAYERS_API_002 2

/**
 * Input parameters for the EOS_Sessions_UnregisterPlayers function.
 */
EOS_STRUCT(EOS_Sessions_UnregisterPlayersOptions002, (
...
#define EOS_SESSIONDETAILS_SETTINGS_API_003 3

/** Common settings associated with a single session */
EOS_STRUCT(EOS_SessionDetails_Settings003, (
	/** API Version: Set this to EOS_SESSIONDETAILS_SETTINGS_API_LATEST. */
	int32_t ApiVersion;
