...
#define EOS_ANTICHEATSERVER_ADDNOTIFYMESSAGETOCLIENT_API_001 1
EOS_STRUCT(EOS_AntiCheatServer_AddNotifyMessageToClientOptions001, (
	/** API Version: Set this to EOS_ANTICHEATSERVER_ADDNOTIFYMESSAGETOCLIENT_API_LATEST. */
	int32_t ApiVersion;
));

#define EOS_ANTICHEATSERVER_ADDNOTIFYCLIENTACTIONREQUIRED_API_001 1
EOS_STRUCT(EOS_AntiCheatServer_AddNotifyClientActionRequiredOptions001, (
	/** API Version: Set this to EOS_ANTICHEATSERVER_ADDNOTIFYCLIENTACTIONREQUIRED_API_LATEST. */
	int32_t ApiVersion;
));

#define EOS_ANTICHEATSERVER_ADDNOTIFYCLIENTAUTHSTATUSCHANGED_API_001 1
EOS_STRUCT(EOS_AntiCheatServer_AddNotifyClientAuthStatusChangedOptions001, (
...
#define EOS_ANTICHEATSERVER_BEGINSESSION_API_003 3
EOS_STRUCT(EOS_AntiCheatServer_BeginSessionOptions003, (
...
#define EOS_ANTICHEATSERVER_ENDSESSION_API_001 1
EOS_STRUCT(EOS_AntiCheatServer_EndSessionOptions001, (
	/** API Version: Set this to EOS_ANTICHEATSERVER_ENDSESSION_API_LATEST. */
	int32_t ApiVersion;
));

#define EOS_ANTICHEATSERVER_REGISTERCLIENT_API_001 1
EOS_STRUCT(EOS_AntiCheatServer_RegisterClientOptions001, (
...
#define EOS_ANTICHEATSERVER_UNREGISTERCLIENT_API_001 1
EOS_STRUCT(EOS_AntiCheatServer_UnregisterClientOptions001, (
...
#define EOS_ANTICHEATSERVER_RECEIVEMESSAGEFROMCLIENT_API_001 1
EOS_STRUCT(EOS_AntiCheatServer_ReceiveMessageFromClientOptions001, (
...
#define EOS_ANTICHEATSERVER_SETCLIENTNETWORKSTATE_API_001 1
EOS_STRUCT(EOS_AntiCheatServer_SetClientNetworkStateOptions001, (
...
#define EOS_ANTICHEATSERVER_GETPROTECTMESSAGEOUTPUTLENGTH_API_001 1
EOS_STRUCT(EOS_AntiCheatServer_GetProtectMessageOutputLengthOptions001, (
...
#define EOS_ANTICHEATSERVER_PROTECTMESSAGE_API_001 1
EOS_STRUCT(EOS_AntiCheatServer_ProtectMessageOptions001, (
...
#define EOS_ANTICHEATSERVER_UNPROTECTMESSAGE_API_001 1
EOS_STRUCT(EOS_AntiCheatServer_UnprotectMessageOptions001, (
