...
#define EOS_SANCTIONS_PLAYERSANCTION_API_002 2

/**
 * Contains information about a single player sanction.
 */
EOS_STRUCT(EOS_Sanctions_PlayerSanction002, (
...
#define EOS_SANCTIONS_QUERYACTIVEPLAYERSANCTIONS_API_002 2

/**
 * Input parameters for the EOS_Sanctions_QueryActivePlayerSanctions API.
 */
EOS_STRUCT(EOS_Sanctions_QueryActivePlayerSanctionsOptions002, (
...
EOS_STRUCT(EOS_Sanctions_QueryActivePlayerSanctionsCallbackInfo, (
	enum { k_iCallback = k_iSanctionsCallbackBase + 0 };
...
#define EOS_SANCTIONS_GETPLAYERSANCTIONCOUNT_API_001 1

/**
 * Input parameters for the EOS_Sanctions_GetPlayerSanctionCount function.
 */
EOS_STRUCT(EOS_Sanctions_GetPlayerSanctionCountOptions001, (
...
#define EOS_SANCTIONS_COPYPLAYERSANCTIONBYINDEX_API_001 1

/**
 * Input parameters for the EOS_Sanctions_CopyPlayerSanctionByIndex function
 */
EOS_STRUCT(EOS_Sanctions_CopyPlayerSanctionByIndexOptions001, (
