...
#define EOS_REPORTS_SENDPLAYERBEHAVIORREPORT_API_002 2

/**
 * Input parameters for the EOS_Reports_SendPlayerBehaviorReport function.
 */
EOS_STRUCT(EOS_Reports_SendPlayerBehaviorReportOptions002, (
...
EOS_STRUCT(EOS_Reports_SendPlayerBehaviorReportCompleteCallbackInfo, (
	enum { k_iCallback = k_iReportsCallbackBase + 0 };
