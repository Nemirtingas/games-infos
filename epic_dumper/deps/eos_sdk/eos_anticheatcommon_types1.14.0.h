...
EOS_STRUCT(EOS_AntiCheatCommon_OnMessageToClientCallbackInfo, (
	enum { k_iCallback = k_iAntiCheatCommonCallbackBase + 0 };
...
EOS_STRUCT(EOS_AntiCheatCommon_OnClientActionRequiredCallbackInfo, (
	enum { k_iCallback = k_iAntiCheatCommonCallbackBase + 1 };
	/** Caller-specified context data */
	void* ClientData;
...
EOS_STRUCT(EOS_AntiCheatCommon_OnClientAuthStatusChangedCallbackInfo, (
	enum { k_iCallback = k_iAntiCheatCommonCallbackBase + 2 };
	/** Caller-specified context data */
	void* ClientData;
...
#define EOS_ANTICHEATCOMMON_SETCLIENTDETAILS_API_001 1
EOS_STRUCT(EOS_AntiCheatCommon_SetClientDetailsOptions001, (
...
#define EOS_ANTICHEATCOMMON_SETGAMESESSIONID_API_001 1
EOS_STRUCT(EOS_AntiCheatCommon_SetGameSessionIdOptions001, (
...
#define EOS_ANTICHEATCOMMON_REGISTEREVENT_API_001 1
...
EOS_STRUCT(EOS_AntiCheatCommon_RegisterEventOptions001, (
...
#define EOS_ANTICHEATCOMMON_LOGEVENT_API_001 1
...
EOS_STRUCT(EOS_AntiCheatCommon_LogEventOptions001, (
...
#define EOS_ANTICHEATCOMMON_LOGGAMEROUNDSTART_API_001 1
EOS_STRUCT(EOS_AntiCheatCommon_LogGameRoundStartOptions001, (
...
#define EOS_ANTICHEATCOMMON_LOGGAMEROUNDEND_API_001 1
EOS_STRUCT(EOS_AntiCheatCommon_LogGameRoundEndOptions001, (
...
#define EOS_ANTICHEATCOMMON_LOGPLAYERSPAWN_API_001 1
EOS_STRUCT(EOS_AntiCheatCommon_LogPlayerSpawnOptions001, (
...
#define EOS_ANTICHEATCOMMON_LOGPLAYERDESPAWN_API_001 1
EOS_STRUCT(EOS_AntiCheatCommon_LogPlayerDespawnOptions001, (
...
#define EOS_ANTICHEATCOMMON_LOGPLAYERREVIVE_API_001 1
EOS_STRUCT(EOS_AntiCheatCommon_LogPlayerReviveOptions001, (
...
#define EOS_ANTICHEATCOMMON_LOGPLAYERTICK_API_002 2
EOS_STRUCT(EOS_AntiCheatCommon_LogPlayerTickOptions002, (
...
#define EOS_ANTICHEATCOMMON_LOGPLAYERUSEWEAPON_API_002 2
...
EOS_STRUCT(EOS_AntiCheatCommon_LogPlayerUseWeaponOptions002, (
...
#define EOS_ANTICHEATCOMMON_LOGPLAYERUSEABILITY_API_001 1
EOS_STRUCT(EOS_AntiCheatCommon_LogPlayerUseAbilityOptions001, (
...
#define EOS_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGE_API_003 3
EOS_STRUCT(EOS_AntiCheatCommon_LogPlayerTakeDamageOptions003, (
