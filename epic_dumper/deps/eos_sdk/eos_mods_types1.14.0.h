...
#define EOS_MOD_IDENTIFIER_API_001 1

/**
 * EOS_Mod_Identifier is used to identify a mod.
 */
EOS_STRUCT(EOS_Mod_Identifier001, (
...
#define EOS_MODS_INSTALLMOD_API_001 1

/**
 * Input parameters for the EOS_Mods_InstallMod Function.
 */
EOS_STRUCT(EOS_Mods_InstallModOptions001, (
...
EOS_STRUCT(EOS_Mods_InstallModCallbackInfo, (
	enum { k_iCallback = k_iModsCallbackBase + 0 };
...
#define EOS_MODS_UNINSTALLMOD_API_001 1

/**
 * Input parameters for the EOS_Mods_UninstallMod Function.
 */
EOS_STRUCT(EOS_Mods_UninstallModOptions001, (
...
EOS_STRUCT(EOS_Mods_UninstallModCallbackInfo, (
	enum { k_iCallback = k_iModsCallbackBase + 1 };
...
#define EOS_MODS_ENUMERATEMODS_API_001 1

/**
 * Input parameters for the EOS_Mods_EnumerateMods Function.
 */
EOS_STRUCT(EOS_Mods_EnumerateModsOptions001, (
...
EOS_STRUCT(EOS_Mods_EnumerateModsCallbackInfo, (
	enum { k_iCallback = k_iModsCallbackBase + 2 };
...
#define EOS_MODS_COPYMODINFO_API_001 1

/**
 * Data for the EOS_Mods_CopyModInfo function.
 */
EOS_STRUCT(EOS_Mods_CopyModInfoOptions001, (
...
#define EOS_MODS_MODINFO_API_001 1
 ...
 */
EOS_STRUCT(EOS_Mods_ModInfo001, (
...
#define EOS_MODS_UPDATEMOD_API_001 1

/**
 * Input parameters for the EOS_Mods_UpdateMod Function.
 */
EOS_STRUCT(EOS_Mods_UpdateModOptions001, (
...
EOS_STRUCT(EOS_Mods_UpdateModCallbackInfo, (
	enum { k_iCallback = k_iModsCallbackBase + 3 };
