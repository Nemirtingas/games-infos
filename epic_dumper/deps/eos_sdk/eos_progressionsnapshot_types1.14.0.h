...
#define EOS_PROGRESSIONSNAPSHOT_BEGINSNAPSHOT_API_001 1
EOS_STRUCT(EOS_ProgressionSnapshot_BeginSnapshotOptions001, (
...
#define EOS_PROGRESSIONSNAPSHOT_ADDPROGRESSION_API_001  1
EOS_STRUCT(EOS_ProgressionSnapshot_AddProgressionOptions001, (
...
#define EOS_PROGRESSIONSNAPSHOT_SUBMITSNAPSHOT_API_001   1
EOS_STRUCT(EOS_ProgressionSnapshot_SubmitSnapshotOptions001, (
...
#define EOS_PROGRESSIONSNAPSHOT_ENDSNAPSHOT_API_001    1
EOS_STRUCT(EOS_ProgressionSnapshot_EndSnapshotOptions001, (
...
EOS_STRUCT(EOS_ProgressionSnapshot_SubmitSnapshotCallbackInfo, (
	enum { k_iCallback = k_iProgressionSnapshotCallbackBase + 0 };
...
#define EOS_PROGRESSIONSNAPSHOT_DELETESNAPSHOT_API_001   1
EOS_STRUCT(EOS_ProgressionSnapshot_DeleteSnapshotOptions001, (
...
EOS_STRUCT(EOS_ProgressionSnapshot_DeleteSnapshotCallbackInfo, (
	enum { k_iCallback = k_iProgressionSnapshotCallbackBase + 1 };
	/* The EOS_EResult code for the operation. EOS_Success indicates that the operation succeeded; other codes indicate errors. */
	EOS_EResult ResultCode;
	/** The Product User ID of the local user to whom the key/value pair belong */
	EOS_ProductUserId LocalUserId;
