...
#define EOS_RTCAUDIO_REGISTERPLATFORMAUDIOUSER_API_001 1

/**
 * This struct is used to inform the audio system of a user.
 */
EOS_STRUCT(EOS_RTCAudio_RegisterPlatformAudioUserOptions001, (
...
#define EOS_RTCAUDIO_UNREGISTERPLATFORMAUDIOUSER_API_001 1

/**
 * This struct is used to remove a user from the audio system.
 */
EOS_STRUCT(EOS_RTCAudio_UnregisterPlatformAudioUserOptions001, (
...
#define EOS_RTCAUDIO_ADDNOTIFYPARTICIPANTUPDATED_API_001 1

/**
 * This struct is used to call EOS_RTCAudio_AddNotifyParticipantUpdated.
 */
EOS_STRUCT(EOS_RTCAudio_AddNotifyParticipantUpdatedOptions001, (
...
EOS_STRUCT(EOS_RTCAudio_ParticipantUpdatedCallbackInfo, (
	enum { k_iCallback = k_iRTCAudioCallbackBase + 0 };
...
#define EOS_RTCAUDIO_ADDNOTIFYAUDIODEVICESCHANGED_API_001 1

/**
 * This struct is used to call EOS_RTCAudio_AddNotifyAudioDevicesChanged.
 */
EOS_STRUCT(EOS_RTCAudio_AddNotifyAudioDevicesChangedOptions001, (
...
EOS_STRUCT(EOS_RTCAudio_AudioDevicesChangedCallbackInfo, (
	enum { k_iCallback = k_iRTCAudioCallbackBase + 1 };
...
#define EOS_RTCAUDIO_GETAUDIOINPUTDEVICESCOUNT_API_001 1

/**
 * Input parameters for the EOS_RTCAudio_GetAudioInputDevicesCount function.
 */
EOS_STRUCT(EOS_RTCAudio_GetAudioInputDevicesCountOptions001, (
...
#define EOS_RTCAUDIO_GETAUDIOINPUTDEVICEBYINDEX_API_001 1

/**
 * Input parameters for the EOS_RTCAudio_GetAudioInputDeviceByIndex function.
 */
EOS_STRUCT(EOS_RTCAudio_GetAudioInputDeviceByIndexOptions001, (
...
#define EOS_RTCAUDIO_AUDIOINPUTDEVICEINFO_API_001 1

/**
 * This struct is used to get information about a specific input device.
 */
EOS_STRUCT(EOS_RTCAudio_AudioInputDeviceInfo001, (
...
#define EOS_RTCAUDIO_GETAUDIOOUTPUTDEVICESCOUNT_API_001 1

/**
 * Input parameters for the EOS_RTCAudio_GetAudioOutputDevicesCount function.
 */
EOS_STRUCT(EOS_RTCAudio_GetAudioOutputDevicesCountOptions001, (
...
#define EOS_RTCAUDIO_GETAUDIOOUTPUTDEVICEBYINDEX_API_001 1

/**
 * Input parameters for the EOS_RTCAudio_GetAudioOutputDeviceByIndex function.
 */
EOS_STRUCT(EOS_RTCAudio_GetAudioOutputDeviceByIndexOptions001, (
...
#define EOS_RTCAUDIO_AUDIOOUTPUTDEVICEINFO_API_001 1

/**
 * This struct is used to get information about a specific output device.
 */
EOS_STRUCT(EOS_RTCAudio_AudioOutputDeviceInfo001, (
...
#define EOS_RTCAUDIO_SETAUDIOINPUTSETTINGS_API_001 1

/**
 * This struct is used to call EOS_RTCAudio_SetAudioInputSettings.
 */
EOS_STRUCT(EOS_RTCAudio_SetAudioInputSettingsOptions001, (
...
#define EOS_RTCAUDIO_SETAUDIOOUTPUTSETTINGS_API_001 1

/**
 * This struct is used to call EOS_RTCAudio_SetAudioOutputSettings.
 */
EOS_STRUCT(EOS_RTCAudio_SetAudioOutputSettingsOptions001, (
...
#define EOS_RTCAUDIO_ADDNOTIFYAUDIOINPUTSTATE_API_001 1

/**
 * This struct is used to call EOS_RTCAudio_AddNotifyAudioInputState.
 */
EOS_STRUCT(EOS_RTCAudio_AddNotifyAudioInputStateOptions001, (
...
EOS_STRUCT(EOS_RTCAudio_AudioInputStateCallbackInfo, (
	enum { k_iCallback = k_iRTCAudioCallbackBase + 2 };
...
#define EOS_RTCAUDIO_ADDNOTIFYAUDIOOUTPUTSTATE_API_001 1

/**
 * This struct is used to call EOS_RTCAudio_AddNotifyAudioOutputState.
 */
EOS_STRUCT(EOS_RTCAudio_AddNotifyAudioOutputStateOptions001, (
...
EOS_STRUCT(EOS_RTCAudio_AudioOutputStateCallbackInfo, (
	enum { k_iCallback = k_iRTCAudioCallbackBase + 3 };
...
#define EOS_RTCAUDIO_ADDNOTIFYAUDIOBEFORESEND_API_001 1

/**
 * This struct is used to call EOS_RTCAudio_AddNotifyAudioBeforeSend.
 */
EOS_STRUCT(EOS_RTCAudio_AddNotifyAudioBeforeSendOptions001, (
...
#define EOS_RTCAUDIO_AUDIOBUFFER_API_001 1
 ...
 */
EOS_STRUCT(EOS_RTCAudio_AudioBuffer001, (
...
EOS_STRUCT(EOS_RTCAudio_AudioBeforeSendCallbackInfo, (
	enum { k_iCallback = k_iRTCAudioCallbackBase + 4 };
...
#define EOS_RTCAUDIO_ADDNOTIFYAUDIOBEFORERENDER_API_001 1

/**
* This struct is used to call EOS_RTCAudio_AddNotifyAudioBeforeRender.
*/
EOS_STRUCT(EOS_RTCAudio_AddNotifyAudioBeforeRenderOptions001, (
...
EOS_STRUCT(EOS_RTCAudio_AudioBeforeRenderCallbackInfo, (
	enum { k_iCallback = k_iRTCAudioCallbackBase + 5 };
...
#define EOS_RTCAUDIO_SENDAUDIO_API_001 1

/**
 * This struct is used to call EOS_RTCAudio_SendAudio.
 */
EOS_STRUCT(EOS_RTCAudio_SendAudioOptions001, (
...
#define EOS_RTCAUDIO_UPDATESENDING_API_001 1

/**
 * This struct is passed in with a call to EOS_RTCAudio_UpdateSending
 */
EOS_STRUCT(EOS_RTCAudio_UpdateSendingOptions001, (
...
EOS_STRUCT(EOS_RTCAudio_UpdateSendingCallbackInfo, (
	enum { k_iCallback = k_iRTCAudioCallbackBase + 6 };
	/** This returns:
...
#define EOS_RTCAUDIO_UPDATERECEIVING_API_001 1

/**
 * This struct is passed in with a call to EOS_RTCAudio_UpdateReceiving.
 */
EOS_STRUCT(EOS_RTCAudio_UpdateReceivingOptions001, (
...
EOS_STRUCT(EOS_RTCAudio_UpdateReceivingCallbackInfo, (
	enum { k_iCallback = k_iRTCAudioCallbackBase + 7 };
	/** This returns:
