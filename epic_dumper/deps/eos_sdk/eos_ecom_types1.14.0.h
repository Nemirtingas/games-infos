...
#define EOS_ECOM_CATALOGOFFER_API_004 4
 ...
 */
EOS_STRUCT(EOS_Ecom_CatalogOffer004, (
...
EOS_STRUCT(EOS_Ecom_QueryEntitlementsOptions002, (
	...
	/** The number of Entitlement Names included in the array, up to EOS_ECOM_QUERYENTITLEMENTS_MAX_ENTITLEMENT_IDS; use zero to request all Entitlements associated with the user's Epic Account. */
...
#define EOS_ECOM_COPYOFFERBYINDEX_API_002 2

/**
 * Input parameters for the EOS_Ecom_CopyOfferByIndex function.
 */
EOS_STRUCT(EOS_Ecom_CopyOfferByIndexOptions002, (
...
#define EOS_ECOM_COPYOFFERBYID_API_002 2

/**
 * Input parameters for the EOS_Ecom_CopyOfferById function.
 */
EOS_STRUCT(EOS_Ecom_CopyOfferByIdOptions002, (
