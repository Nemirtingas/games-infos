...
#define EOS_PLAYERDATASTORAGE_FILEMETADATA_API_003 3

/**
 * Metadata information for a specific file
 */
EOS_STRUCT(EOS_PlayerDataStorage_FileMetadata003, (
...
#define EOS_PLAYERDATASTORAGE_DELETECACHEOPTIONS_API_001 1
/**
 * Input data for the EOS_TitleStorage_DeleteCache function
 */
EOS_STRUCT(EOS_PlayerDataStorage_DeleteCacheOptions001, (
